...
###Welcome to Dwarf2D!
Dwarf2D is an easy to use set of utilites wrapped around <a href='http://lwjgl.org/' title='lwjgl.org'>LWJGL</a>, <a href='http://www.opengl.org/' title='openGL.org'>OpenGL</a> and <a href='OpenAl' title='http://openAl.org'>OpenAl</a> design to make Java 2D game development easier and ultimately better for all.
