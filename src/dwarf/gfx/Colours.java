...
public interface Colours {
    ...
    /**
     * The colour light grey. In the default sRGB space.
     */
    public final static Colour lightGrey = new Colour(0xc0, 0xc0, 0xc0);

    /**
     * The colour light grey. In the default sRGB space.
     */
    public final static Colour LIGHT_GREY = lightGrey;
    ...
    /**
     * The colour pink. In the default sRGB space.
     */
    public final static Colour pink = new Colour(0xff, 0xaf, 0xaf);
    ...
    /**
     * The colour orange. In the default sRGB space.
     */
    public final static Colour orange = new Colour(0xff, 0xc8, 0x0);
