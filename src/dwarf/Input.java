...
public final class Input {
    ...
    public static final int MOUSE_LEFT = 0x0;
    public static final int MOUSE_RIGHT = 0x1;
    public static final int MOUSE_MIDDLE = 0x2;

    public static final int NUM_KEYCODES = 256;
    public static final int NUM_MOUSEBUTTONS = 5;

    private static ArrayList<Integer> currentKeys;
    private static ArrayList<Integer> downKeys;
    private static ArrayList<Integer> upKeys;

    private static ArrayList<Integer> currentMouse;
    private static ArrayList<Integer> downMouse;
    private static ArrayList<Integer> upMouse;
    ...
    public static boolean isKeyPressed(String keyName) {
        return downKeys.contains(Input.getKeyCode(keyName));
    }
    ...
    public static boolean isMouseClicked(String buttonName) {
        return downMouse.contains(Input.getKeyCode(buttonName));
    }
    ...
    public static boolean isMouseRealesed(String buttonName) {
        return upMouse.contains(Input.getKeyCode(buttonName));
    }
